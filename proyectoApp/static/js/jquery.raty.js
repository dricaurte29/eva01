...
(function(root, factory) {
  ...
  $.raty = {
    ...
    half:         false,
    halfShow:     true,
    hints:        ['malo', 'pobre', 'regular', 'bueno', 'perfecto'],
    iconRange:    undefined,
    mouseout:     undefined,
    mouseover:    undefined,
    ...
    single:       false,
    space:        true,
    starHalf:     '<i class="fa fa-star-half" aria-hidden="true"></i>',
    starOff:      '<i class="fa fa-star-o" aria-hidden="true"></i>',
    starOn:       '<i class="fa fa-star" aria-hidden="true"></i>',
    starType:     'img',
    target:       undefined,
    targetFormat: '{score}',
    targetKeep:   false,
